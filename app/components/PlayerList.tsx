...
import playerGroup from "../../public/assets/user-group.png";
    ...
    return (
        <div className="w-full mx-auto">
            <div className="flex items-center justify-between gap-1 mb-4">
                <h1 className="text-[32px] leading-[28px] tracking-[0] font-bold text-night-black">
                    Players
                </h1>
                <div className="flex items-center gap-2">
                    <div className="size-[32px]">
                        <Image
                            ...
                            src={playerGroup}
                            alt="Player Group Icon"
                        />
                    </div>
                    <span className="text-2xl font-normal leading-[100%] tracking-[0%]">
                        5/11
                    </span>
                </div>
            </div>
