...
import takaIcon from "../../public/assets/currency-bangladeshi.png";
import difficultyIcon from "../../public/assets/Difficulty Icons (1).png";
import mapPin from "../../public/assets/location_on.png";
        ...
        <div className="rounded-[30px] border-[1.25px] border-light-gray-stroke overflow-hidden shadow-sm flex-shrink-0 w-full">
            ...
            <div className="p-4">
                ...
                <div className="flex items-end justify-between border-gray-200 ">
                    <span className="text-sm font-normal leading-[100%] tracking-[0%] text-[#171717]">
                        {attending}
                    </span>
                    ...
                    <div className="flex flex-col items-end gap-1">
                        ...
                        <div className="flex items-center">
                            ...
                            <span className="text-lg text-[#808080] font-normal leading-[100%] tracking-[0%]">
                                /person
                            </span>
                        </div>
                    </div>
