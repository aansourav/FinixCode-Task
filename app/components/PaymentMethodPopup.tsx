...
import bKashImg from "../../public/assets/arcticons_bkash.png";
import CashLogo from "../../public/assets/hugeicons_payment-02.png";
import moneyImg from "../../public/assets/tdesign_money-filled.png";
                    ...
                    <div className="space-y-6">
                        <label className="flex items-start cursor-pointer">
                            ...
                            <div className="ml-3">
                                ...
                                >
                                    Send the payment now via bKash to confirm
                                    your spot instantly.
                                </p>
                            </div>
                        </label>
