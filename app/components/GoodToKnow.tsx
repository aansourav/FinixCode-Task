...
import calendarIcon from "../../public/assets/calendar (2).png";
import clockIcon from "../../public/assets/clock.png";
import tableIcon from "../../public/assets/tabler_soccer-field.png";
                ...
                <div className="flex flex-wrap gap-3">
                    ...
                    <div className="bg-pure-green text-[#F7F7F7] p-6 w-[523px] rounded-2xl">
                        ...
                        <ul className="list-disc pl-5 font-medium leading-[100%] tracking-[0%] space-y-[6px] list mb-4 text-lg">
                            ...
                            <li>
                                Full refund if game is cancelled due to low
                                attendance
                            </li>
                        </ul>
