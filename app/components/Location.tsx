        ...
        >
            <div className="w-full">
                ...
                <div className="flex flex-col md:flex-row md:items-start justify-between w-full mt-10">
                    <div className="">
                        <h3 className="text-2xl font-bold text-gray-blue">
                            NDE Field
                        </h3>
                    ...
                    <div>
                        <button className="border border-gray-blue font-medium text-lg leading-[100%] tracking-[0%] rounded-full py-[15px] px-4 text-gray-blue hover:bg-gray-50 transition-colors mt-2 sm:mt-0">
                            Open maps
                        </button>
                    </div>
                </div>
